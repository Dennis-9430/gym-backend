...
El formulario de registro debe ser SIMPLE y optimizado para evitar abandono durante el onboarding.

NO pedir demasiados campos inicialmente.

---

# CAMPOS REQUERIDOS EN REGISTER
...
NO pedir username obligatorio durante el registro.

El username del OWNER debe ser opcional y poder configurarse posteriormente dentro del sistema.
...
Cuando se crea el tenant automáticamente también debe crearse el OWNER principal.

Inicialmente el OWNER puede existir SIN username.
...
# LOGIN INICIAL DEL OWNER

Inicialmente el OWNER debe ingresar usando:
...
# CONFIGURACIÓN POSTERIOR DEL USERNAME

Una vez dentro del sistema el OWNER puede configurar opcionalmente un username.
...
Después de configurar username el OWNER podrá ingresar usando:
...
El OWNER principal puede:

* ingresar con email
* ingresar con username si lo configuró

---

# EMPLOYEADOS

Los empleados y admins secundarios normalmente ingresan usando:

```txt
username + password
```

No es obligatorio que empleados tengan email.

---

# PERFIL DEL OWNER

El OWNER NO debe gestionarse igual que empleados normales.
...
Separar ambas secciones para evitar:

* eliminación accidental
* desactivación accidental
* cambios de permisos incorrectos
